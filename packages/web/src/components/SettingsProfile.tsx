    ...
    <Flex direction='column' width='100%'>
      <Section pt={4} pb={16}>
        ...
        <Flex direction='column' py={6} gap={4} borderBottom='1px solid' borderColor='gray.200'>
          <Text variant='text-field' color='darkgray.100'>Provider that you use to log in to Proautoma</Text>
          <Flex maxW='450px' p={4} borderRadius={8} border='1px solid' borderColor='gray.200' gap={2}>
            <Image src={googleIcon} w={10} h={10} p={1} borderRadius={24} border='1px solid' borderColor='gray.200' />
            <Flex direction='column' gap={1}>
              <Text cursor='pointer' variant='text-field' color='black'>Google</Text>
              <Text cursor='pointer' variant='paragraph' color='gray.300'>example@mail.com</Text>
            </Flex>
            <Spacer></Spacer>
            <Text cursor='pointer' variant='text-field' color='darkblue.100'>Disconnect</Text>
          </Flex>
        </Flex>
        <Flex alignItems='center' py={6} gap={6}>
          <Avatar
            ...
            cursor='pointer'
          />
          <input type='file' accept='image/*' ref={inputRef} style={{ display: 'none' }} onChange={onImageChange}></input>
          <Text variant='text-field' cursor='pointer' color='darkblue.100' onClick={() => inputRef.current?.click()}>
            Upload your photo
          </Text>
        </Flex>
      ...
      <Section pt={4} pb={6}>
        <Text pt={2} variant='title' color='black'>Password</Text>
        <Box mt={6} pb={4} borderBottomColor='lightgray.100' borderBottomWidth='1px' borderStyle='solid'>
          <InputField>
            <Text variant='details' color='black' mb={1}>Password</Text>
            <Input placeholder='Password' autoComplete='new-password' type='password' {...register(`settings.security.password` as const)} />
