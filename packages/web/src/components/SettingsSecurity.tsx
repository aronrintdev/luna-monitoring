import { Box, Flex, Input, FlexProps, FormControl, Switch, FormLabel } from '@chakra-ui/react'
        ...
        <Box mt={6}>
          <FormControl display='flex' alignItems='center'>
            <Switch
              ...
              size='sm'
              mr={2}
              {...register(`settings.security.single_sign_on` as const)}
            />
        ...
        <Box mt={6}>
          <FormControl display='flex' alignItems='center'>
            <Switch
              ...
              size='sm'
              mr={2}
              {...register(`settings.security.enforce_2fa_for_all` as const)}
            />
        ...
        <Box mt={6}>
          <FormControl display='flex' alignItems='center'>
            <Switch
              ...
              size='sm'
              mr={2}
              {...register(`settings.security.advanced_security` as const)}
            />
        ...
        <Box mt={6}>
          <FormControl display='flex' alignItems='center'>
            <Switch
              ...
              size='sm'
              mr={2}
              {...register(`settings.security.activity_logs` as const)}
            />
